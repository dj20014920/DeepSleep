...
public final class PremiumBadgeView: UIView {
    ...
    private func setupRainbowColors() { gradientColors = GradientBadgePalette.proColors() }
    
    private func setupGrayscaleColors() { gradientColors = GradientBadgePalette.freeColors() }
