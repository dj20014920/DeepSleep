...
### 🎯 Fallback 우선순위 (비용 기준)
1. **Gemini 2.0 Flash-Lite** (프리셋 추천 용도,구독 결제 유저 대나무숲 친구선택 가능)
2. **OpenAI GPT-4o Mini** (중간 비용, 구독 결제 유저 대나무숲 친구선택 가능)
3. **Claude Haiku 3.5** (최고 품질, 무료 구독유저는 사용 불가, 유료 구독유저만 사용 가능-횟수제한있음30회)
