...
//    - pack.model.gemma270.q8 → gemma-3-270m-it-Q8_0.gguf (~292MB)
//    - pack.model.qwen05b.q4 → qwen2.5-0.5b-instruct-q4_k_m.gguf (~491MB)
//    - pack.model.gemma1b.iq4 → gemma-3-1b-it-IQ4_XS.gguf (~714MB)
//
